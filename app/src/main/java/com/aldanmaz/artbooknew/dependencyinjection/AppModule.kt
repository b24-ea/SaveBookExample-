package com.aldanmaz.artbooknew.dependencyinjection
...
import com.aldanmaz.artbooknew.roomdb.ArtDatabase
import com.aldanmaz.artbooknew.util.Util.BASE_URL
...
object AppModule {
   ...
   @Singleton
   @Provides
    fun injectRoomDatabase(@ApplicationContext
