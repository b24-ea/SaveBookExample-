...
import com.aldanmaz.artbooknew.databinding.FragmentImageApiBinding
        ...
        viewModel.imageList.observe(viewLifecycleOwner, {
            when(it.status) {
                Status.SUCCESS -> {
                    ...
                    fragmentBinding?.prograssBar?.visibility = View.GONE
                }
                Status.ERROR -> {
                ...
                Status.LOADING -> {
                    fragmentBinding?.prograssBar?.visibility = View.VISIBLE
